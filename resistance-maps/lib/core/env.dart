class Env {
  ...
  static const oidcIssuerPublic = String.fromEnvironment('OIDC_ISSUER_PUBLIC', defaultValue: '');
  static const oidcClientId = String.fromEnvironment('OIDC_CLIENT_ID', defaultValue: 'resistance-mobile');
